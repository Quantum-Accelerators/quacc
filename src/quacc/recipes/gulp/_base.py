...
def base_fn(
    ...
    option_defaults = recursive_merge_dicts(
        option_defaults,
        {
    ...
    keywords = recursive_merge_dicts(keyword_defaults, keyword_swaps)
    options = recursive_merge_dicts(option_defaults, option_swaps)
