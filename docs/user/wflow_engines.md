...
=== "Parsl"
    ...
    **The Inefficient Way**
    ...
    def bulk_to_slabs_app(atoms):
        ...
        return bulk_to_slabs_flow(atoms, slab_static_job=None)
    ...
    **The Efficient Way**
    ...
    # Define the workflow
    future1 = relax_app(atoms)
    future2 = bulk_to_slabs_flow(future1.result(), slab_static_job=None)
