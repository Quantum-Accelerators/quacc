...
**Warning**: Currently, this package is under active development and should be considered *highly experimental.* While the code itself is fully documented, user-friendly API documentation will be provided once the code is in a more stable state.
