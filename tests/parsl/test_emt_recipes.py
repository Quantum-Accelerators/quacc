...
def test_settings_swap(tmp_path_factory):
    ...
    future1 = bulk_to_slabs_flow(atoms, job_decorators={"relax_job": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
    future2 = bulk_to_slabs_flow(atoms, job_decorators={"relax_job": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
    future3 = bulk_to_slabs_flow(atoms, job_decorators={"relax_job": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
...
def test_settings_swap_all(tmp_path_factory):
    ...
    future1 = bulk_to_slabs_flow(atoms, job_decorators={"all": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
    future2 = bulk_to_slabs_flow(atoms, job_decorators={"all": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
    future3 = bulk_to_slabs_flow(atoms, job_decorators={"all": job(settings_swap={"RESULTS_DIR": tmp_dir1})})
    future1.result(), future2.result(), future3.result()
