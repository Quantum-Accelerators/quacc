...
def test_summarize_bader_run(monkeypatch, run1, tmp_path, monkeypatch:
    monkeypatch.setattr(
...
def test_summarize_chargemol_run(monkeypatch, run1, tmp_path, monkeypatch:
...
def test_summarize_bader_and_chargemol_run(monkeypatch, run1, tmp_path, monkeypatch:
    monkeypatch.setattr(
        "quacc.schemas.vasp.bader_analysis_from_path", mock_bader_analysis
    )
    monkeypatch.setattr("quacc.schemas.vasp.ChargemolAnalysis", mock_chargemol_analysis)
...
def test_no_bader(run1, tmp_path, monkeypatch:
    monkeypatch.chdir(tmp_path, monkeypatch
...
def test_no_chargemol(run1, tmp_path, monkeypatch:
    monkeypatch.chdir(tmp_path, monkeypatch
