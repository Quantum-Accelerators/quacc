...
def test_relax_job_missing_pynanoflann(monkeypatch):
    ...
    import quacc.recipes.mlp._util

    quacc.recipes.mlp._util.pick_calculator.__wrapped__.cache_clear()
    monkeypatch.setattr("importlib.util.find_spec", mock_find_spec)
    monkeypatch.setattr("quacc.recipes.mlp._util.find_spec", mock_find_spec)
